...
const DICT = {
  en: {
    ...
    'step2.toteHint': 'You can customise both the front and the back of the tote bag with any patches you like. Minimum {min} patches required.',
    'noun.frame': 'frame',
    ...
    'price.addAtLeast': 'Add at least {n} {noun}',
    ...
    'price.patchCount': '{n} patch',
    'price.patchCount_plural': '{n} patches',
    'price.aimFor': ' · aim for {min}–{max}',
    'price.base': '{name} base · {price}',
    'price.plusCharms': '+ charms {price}',
    'price.plusPatches': '+ patches {price}',
    'price.patchDiscount': 'Patch discount ({pct}% off)',
    'price.estimatedTotal': 'Estimated total',
    'price.marketLoading': 'Confirming market price. {currency} estimate shown.',
    'price.marketUnavailable': 'Market price unavailable. {currency} estimate only; confirmed at checkout.',
    'price.marketEstimate': 'Decoration prices are estimated; confirmed at checkout.',
    'price.total': 'Total',
    ...
    'msg.addAtLeastHave': 'Please add at least {min} {noun} before ordering — you have {have}.',
    ...
    'step2.mobileTitleTote': 'Step 2: Add your patches',
    ...
    'step2.desktopTitleTote': 'Step 2 · Add your patches',
    ...
    'discount.tier5': '5+ patches — 10% off',
    'discount.tier8': '8+ patches — 15% off',
    'discount.tier10': '10+ patches — 20% off',
  ...
  zh: {
    ...
    'price.ready': '可以下单',
    'price.addAtLeast': '至少添加 {n} 个{noun}',
    ...
    'price.patchCount': '{n} 个贴布',
    'price.patchCount_plural': '{n} 个贴布',
    'price.aimFor': ' · 建议 {min}–{max} 个',
    'price.base': '{name} 基础价 · {price}',
    'price.plusCharms': '+ 挂饰 {price}',
    'price.plusPatches': '+ 贴布 {price}',
    ...
    'msg.addAtLeastHave': '下单前请至少添加 {min} 个{noun} — 你目前有 {have} 个。',
  ...
  fr: {
    ...
    'price.addAtLeast': 'Ajoutez au moins {n} {noun}',
    ...
    'price.patchCount': '{n} patch',
    'price.patchCount_plural': '{n} patchs',
    'price.aimFor': ' · visez {min}–{max}',
    'price.base': '{name} base · {price}',
    'price.plusCharms': '+ breloques {price}',
    'price.plusPatches': '+ patchs {price}',
    ...
    'msg.addAtLeastHave': 'Ajoutez au moins {min} {noun} avant de commander — vous en avez {have}.',
    ...
    'step2.mobileTitleTote': 'Étape 2 : Ajoutez vos patchs',
    ...
    'step2.desktopTitleTote': 'Étape 2 · Ajoutez vos patchs',
  ...
  de: {
    ...
    'price.addAtLeast': 'Mindestens {n} {noun} hinzufügen',
    ...
    'msg.addAtLeastHave': 'Bitte füge vor der Bestellung mindestens {min} {noun} hinzu — du hast {have}.',
    ...
    'step2.mobileTitleTote': 'Schritt 2: Patches hinzufügen',
    ...
    'step2.desktopTitleTote': 'Schritt 2 · Füge deine Patches hinzu',
  ...
  es: {
    ...
    'price.addAtLeast': 'Añade al menos {n} {noun}',
    ...
    'price.patchCount': '{n} parche',
    'price.patchCount_plural': '{n} parches',
    'price.aimFor': ' · apunta a {min}–{max}',
    'price.base': '{name} base · {price}',
    'price.plusCharms': '+ dijes {price}',
    'price.plusPatches': '+ parches {price}',
    ...
    'msg.addAtLeastHave': 'Añade al menos {min} {noun} antes de pedir — tienes {have}.',
  ...
  ja: {
    ...
    'price.addAtLeast': '{noun}を{n}個以上追加してください',
    ...
    'price.patchCount': 'パッチ{n}個',
    'price.patchCount_plural': 'パッチ{n}個',
    'price.aimFor': ' · {min}〜{max}個が目安',
    'price.base': '{name} 基本 · {price}',
    'price.plusCharms': '+ チャーム {price}',
    'price.plusPatches': '+ パッチ {price}',
    ...
    'msg.addAtLeastHave': 'ご注文前に{noun}を{min}個以上追加してください — 現在{have}個です。',
