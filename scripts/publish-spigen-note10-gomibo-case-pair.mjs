...
const REVIEW_PATH = 'reference/case-history/generated/all-phone-real-image-completion/spigen-note10-gomibo-case-review.json'
const PUBLISHER_PATH = 'scripts/publish-shopify-iphone-without-gel-images.mjs'
const REPORT_PATH = 'reference/case-history/generated/all-phone-real-image-completion/shopify-spigen-note10-gomibo-upload-report.json'
const EXPECTED = {
  modelId: 'galaxy-note-10',
  sku: '628CS27374',
  gtin: '8809671012198',
  widthMm: 71.8,
  heightMm: 151.0,
  reportedValue: '151.0 x 71.8 x 7.9',
}
...
assert(model.reviewStatus === 'accepted' && model.publicationEligible, 'Galaxy Note 10 is not accepted')
...
assert(model.geometryQa?.cameraOpeningProfilePassed, 'Strict Note 10 opening profile failed')
