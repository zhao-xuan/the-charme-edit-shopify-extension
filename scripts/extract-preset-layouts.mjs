 ...
 * in the editor.
 *
 * Run: node scripts/extract-preset-layouts.mjs
 * -------------------------------------------------------------------------
 */
...
async function main() {
  ...
  console.log(`\nwrote reference/presets/{layouts,case-rects,pieces}.json (${Object.keys(layouts).length} designs)`) // eslint-disable-line
}
