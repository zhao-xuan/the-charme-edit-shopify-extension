...
ULTRA-CLOSE OUTER FIT - NON-NEGOTIABLE: along the complete LEFT edge below the camera shoulder, complete BOTTOM edge, complete RIGHT edge and top-right outer segment, expand the Gel outward to the inner silicone wall exactly as in IMAGE 3. The OUTERMOST raised-bead centre must sit directly on IMAGE 4's red line; when the red line is removed, leave only one continuous shell-colour hairline and a tiny contact shadow. Target roughly 0.08%-0.16% of case width, never more than 0.20%; at this source scale, the visible flat-shell reveal must read as approximately one pixel and never more than two pixels. This is closer than the existing Black/White result: resolve any ambiguity by expanding outward, never by shrinking or centring the slab. Never widen that reveal, touch or overlap the silicone wall, erase the shell line, fuse Gel into silicone or create a double rim.
