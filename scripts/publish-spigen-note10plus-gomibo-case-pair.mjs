...
const REVIEW_PATH = 'reference/case-history/generated/all-phone-real-image-completion/spigen-note10plus-gomibo-case-review.json'
const PUBLISHER_PATH = 'scripts/publish-shopify-iphone-without-gel-images.mjs'
const REPORT_PATH = 'reference/case-history/generated/all-phone-real-image-completion/shopify-spigen-note10plus-gomibo-upload-report.json'
const EXPECTED = {
  modelId: 'galaxy-note-10-plus',
  sku: '627CS27331',
  gtin: '8809671011764',
  widthMm: 77.2,
  heightMm: 162.3,
  reportedValue: '162.3 x 77.2 x 7.9',
}
...
assert(model.reviewStatus === 'accepted' && model.publicationEligible, 'Galaxy Note 10 Plus is not accepted')
...
assert(model.geometryQa?.cameraOpeningProfilePassed, 'Strict Note 10 Plus opening profile failed')
